...
class PathNode:
    ...
    def set_variable_state(self, variable_name: str, taint_info: Dict[str, Any]) -> None:
        """
...
class PathSensitiveAnalyzer:
    ...
    def _collect_paths(self, node: PathNode, current_path: List[PathNode], all_paths: List[List[PathNode]]) -> None:
