...
"""
    ...
    def format_report(self, data: Dict[str, Any]) -> str:
        ...
        vulnerability_principle = self._generate_vulnerability_principle(data, vuln_info)
        ...
        vulnerability_verification = self._generate_vulnerability_verification(vuln_info)
    ...
    def _generate_vulnerability_principle(self, data: Dict[str, Any], vuln_info: Dict[str, Any]) -> str:
        """
        Generate vulnerability principle analysis.
    ...
    def _generate_impact_scope(self, data: Dict[str, Any], vuln_info: Dict[str, Any]) -> str:
        """
