...
- `--minimal-output`: Output only vulnerabilities and call_chains fields (default: enabled).
- `--no-minimal-output`: Output full analysis results including summary and imports.
